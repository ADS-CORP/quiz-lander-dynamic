...
export const pfasOffer: LandingPageContent = {
  abbreviation: 'pfas',
  title: "PFAS Water Contamination Compensation",
  headline: "Join Thousands Pursuing Justice",
  description: "Find out if you qualify for compensation",
  metaTitle: "PFAS & AFFF Water Contamination Compensation",
  metaDescription: "Were you exposed to PFAS or AFFF foam contamination in your tap water or at work? You may be eligible for significant compensation. Free case review available.",
  quizConfig: {
    apiUrl: "/api",
    debug: true
  },
  faqSection: {
    ...
    faqs: [
      ...
      {
        question: "What are PFAS and AFFF?",
      ...
      {
        question: "How do I know if I was exposed to PFAS?",
        answer: "You may have been exposed to PFAS if you lived or worked near facilities that manufactured or extensively used PFAS chemicals, military bases where AFFF was used, or if you consumed contaminated water. Environmental testing or water quality reports for your area can help confirm exposure. Our legal team can help gather this evidence."
      },
      {
      ...
      },
      {
        ...
        answer: "Just ask us! It's free to check if you qualify. We'll ask you a few simple questions about your PFAS exposure and health. There's no commitment to file a case."
      }
    ]
  },
  settlementSection: {
    ...
    settlements: [
      {
        ...
        amount: "670,700,000",
        detail: "Water contamination affecting 3,500 residents",
        timeline: "2017 Settlement",
        link: "https://www.reuters.com/article/us-du-pont-lawsuit-west-virginia-idUSKBN15S18U"
      },
      {
        name: "3M Company",
        location: "Minnesota",
        amount: "850,000,000",
        detail: "Groundwater contamination settlement",
        timeline: "2018 Settlement",
        link: "https://www.mprnews.org/story/2018/02/20/minnesota-3m-pfcs-settlement"
      },
      {
        name: "Various Manufacturers",
        location: "Michigan",
        amount: "54,000,000",
        detail: "Settlement for contamination in Wolverine, MI",
        timeline: "2020 Settlement",
        link: "https://www.mlive.com/news/grand-rapids/2020/02/54m-wolverine-worldwide-3m-pfas-settlement-gets-preliminary-approval.html"
      },
      {
        ...
        link: "https://www.npr.org/2023/06/22/1183636743/3m-pfas-settlement-water-systems-forever-chemicals"
      },
      {
        name: "Firefighter Class Action",
        location: "Multiple States",
        amount: "11,500,000",
        detail: "Settlement for firefighters exposed to AFFF",
        timeline: "2021 Settlement",
        link: "https://www.classaction.org/news/class-action-settlement-11.5m-deal-reached-to-resolve-certain-afff-firefighting-foam-blood-testing-claims"
      },
      {
        name: "Tyco Fire Products",
        location: "Wisconsin",
        amount: "17,500,000",
        detail: "Settlement for PFAS contamination from firefighting foam",
        timeline: "2022 Settlement",
        link: "https://www.wpr.org/tyco-johnson-controls-settle-pfas-lawsuit-marinette-17-5m"
      },
      {
        name: "Multiple Defendants",
        location: "United States",
        amount: "10,300,000,000",
        detail: "Settlement for PFAS claims by water providers",
        timeline: "2023 Settlement",
        link: "https://www.reuters.com/legal/dupont-chemours-corteva-reach-10-bln-settlement-resolve-forever-chemicals-claims-2023-06-30/"
      }
    ]
  }
};
