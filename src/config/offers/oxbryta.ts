...
export const oxbrytaOffer: LandingPageContent = {
  ...
  faqSection: {
    ...
    faqs: [
      ...
      {
        question: "Which Oxbryta products are included?",
        answer: "All forms of Oxbryta (voxelotor) prescribed for sickle cell disease are included in this lawsuit, including tablets and dispersible tablet forms for both adult and pediatric patients."
      },
      {
        question: "What side effects make me eligible?",
      ...
      },
      {
        ...
        answer: "Don't worry about gathering all the records yourself. We can help obtain your medical records, prescription history, and other documentation needed to support your case."
      },
      {
      ...
      },
      {
        ...
        answer: "Just ask us! It's free to check if you qualify. We'll ask you a few simple questions about your Oxbryta use and health complications. There's no commitment to file a case."
      }
    ]
  },
  settlementSection: {
    ...
    settlements: [
      {
        ...
        location: "Louisiana",
        amount: "36,800,000",
        detail: "Severe complications from blood sugar medication",
        timeline: "2014 Settlement",
        link: "https://www.reuters.com/article/markets/stocks/us-judge-slashes-9-bln-award-vs-takeda-lilly-over-diabetes-drug-idUSL1N0SM2GG/"
      },
      {
        name: "Andrew Y.",
        location: "Pennsylvania",
        amount: "70,000,000",
        detail: "Serious side effects from antipsychotic drug",
        timeline: "2016 Settlement",
        link: "https://www.bloomberg.com/news/articles/2019-11-26/j-j-fails-to-get-70-million-risperdal-award-tossed-on-appeal"
      },
      {
        name: "Stevie G.",
        location: "Illinois",
        amount: "15,000,000",
        detail: "Birth defect from psychiatric medication",
        timeline: "2017 Settlement",
        link: "https://www.reuters.com/article/business/healthcare-pharmaceuticals/abbvie-must-pay-15-million-in-depakote-birth-defect-trial-jury-idUSKBN1902LI/"
      },
      {
        name: "Mariola Z.",
        location: "Illinois",
        amount: "14,000,000",
        detail: "Suffered stroke after taking birth control drug",
        timeline: "2014 Settlement",
        link: "https://www.foxnews.com/health/14-million-awarded-in-lawsuit-linking-birth-control-pill-yasmin-to-stroke"
      },
      {
        name: "Lyam K.",
        location: "Pennsylvania",
        amount: "2,500,000",
        detail: "Birth defects from antidepressant medication",
        timeline: "2009 Settlement",
        link: "https://www.forbes.com/sites/robwaters/2012/07/12/glaxosmithklines-3-billion-hit-deterrent-or-business-expense/"
      }
    ]
  }
};
