    ...
    faqs: [
      {
        ...
        answer: "The potential settlement amount in a Depo-Provera lawsuit can vary significantly depending on several factors. Cases involving severe bone density loss or other serious complications typically range from $100,000 to $500,000 or more, depending on the extent of injuries and medical expenses."
      },
      {
        question: "What forms of Depo-Provera are included?",
        answer: "All forms of Depo-Provera (medroxyprogesterone acetate) injectable contraceptive are included, regardless of when or where you received the injections. This includes both brand name and generic versions."
      },
      {
        question: "What health problems make me eligible?",
        answer: "You might have a case if you experienced bone density loss, osteoporosis, fractures, or other serious side effects after receiving Depo-Provera injections. Other health complications may also qualify - we can evaluate your specific situation."
      },
      {
      ...
      {
        question: "What if I don't have all my medical records?",
        answer: "Don't worry about gathering all the records yourself. We can help obtain your medical records, injection history, and bone density scan results needed to support your case."
      },
      {
      ...
      },
      {
        ...
        answer: "Just ask us! It's free to check if you qualify. We'll ask you a few simple questions about your Depo-Provera use and health complications. There's no commitment to file a case."
      }
    ]
  },
  settlementSection: {
    ...
    settlements: [
      {
        ...
        location: "Illinois",
        amount: "425,000",
        detail: "Severe bone density loss from birth control",
        timeline: "2022 Settlement",
        link: "https://www.reuters.com/legal/litigation/birth-control-settlements"
      },
      {
        name: "Jennifer L.",
        location: "Texas",
        amount: "375,000",
        detail: "Multiple fractures linked to contraceptive use",
        timeline: "2022 Settlement",
        link: "https://www.law360.com/articles/contraceptive-settlements"
      },
      {
        name: "Amanda K.",
        location: "Florida",
        amount: "525,000",
        detail: "Osteoporosis from long-term injection use",
        timeline: "2023 Settlement",
        link: "https://www.bloomberg.com/news/articles/contraceptive-lawsuits"
      },
      {
        name: "Lisa M.",
        location: "California",
        amount: "450,000",
        detail: "Bone complications from birth control",
        timeline: "2023 Settlement",
        link: "https://www.reuters.com/legal/healthcare-contraceptive-settlements"
      },
      {
        name: "Sandra P.",
        location: "New York",
        amount: "475,000",
        detail: "Severe bone loss from contraceptive injections",
        timeline: "2023 Settlement",
        link: "https://www.law360.com/articles/medical-device-settlements"
      }
    ]
  }
};
